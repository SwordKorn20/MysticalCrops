 ...
 */
public class CopperSeedItem extends Item implements IPlantable
{
    private String name = "copperSeed";

    public CopperSeedItem(String unlocalisedName)
    {
        super();
                             ...
                             float hitX, float hitY, float hitZ)
    {
        ...
        {
            world.setBlockState(pos.offset(EnumFacing.UP), CropBlocks.copperCropBlock.getDefaultState());
    ...
    {
        return CropBlocks.copperCropBlock.getDefaultState();
    }
}
