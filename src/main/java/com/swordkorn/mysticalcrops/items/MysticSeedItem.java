 ...
 */
public class MysticSeedItem extends Item implements IPlantable
{
    private String name = "mysticSeed";

    public MysticSeedItem(String unlocalisedName)
    {
        super();
                             ...
                             float hitX, float hitY, float hitZ)
    {
        ...
        {
            world.setBlockState(pos.offset(EnumFacing.UP), CropBlocks.mysticCropBlock.getDefaultState());
    ...
    {
        return CropBlocks.mysticCropBlock.getDefaultState();
    }
}
