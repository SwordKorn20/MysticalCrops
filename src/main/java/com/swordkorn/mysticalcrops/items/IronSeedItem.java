 ...
 */
public class IronSeedItem extends Item implements IPlantable
{
    private String name = "ironSeed";

    public IronSeedItem(String unlocalisedName)
    {
        super();
                             ...
                             float hitX, float hitY, float hitZ)
    {
        ...
        {
            world.setBlockState(pos.offset(EnumFacing.UP), CropBlocks.ironCropBlock.getDefaultState());
    ...
    {
        return CropBlocks.ironCropBlock.getDefaultState();
    }
}
