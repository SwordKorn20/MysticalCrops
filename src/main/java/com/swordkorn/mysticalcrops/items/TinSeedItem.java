 ...
 */
public class TinSeedItem extends Item implements IPlantable
{
    private String name = "tinSeed";

    public TinSeedItem(String unlocalisedName)
    {
        super();
                             ...
                             float hitX, float hitY, float hitZ)
    {
        ...
        {
            world.setBlockState(pos.offset(EnumFacing.UP), CropBlocks.tinCropBlock.getDefaultState());
    ...
    {
        return CropBlocks.tinCropBlock.getDefaultState();
    }
}
