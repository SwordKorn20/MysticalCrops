 ...
 */
public class RedstoneSeedItem extends Item implements IPlantable
{
    private String name = "redstoneSeed";

    public RedstoneSeedItem(String unlocalisedName)
    {
        super();
                             ...
                             float hitX, float hitY, float hitZ)
    {
        ...
        {
            world.setBlockState(pos.offset(EnumFacing.UP), CropBlocks.redstoneCropBlock.getDefaultState());
    ...
    {
        return CropBlocks.redstoneCropBlock.getDefaultState();
    }
}
