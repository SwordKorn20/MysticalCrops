 ...
 */
public class DiamondSeedItem extends Item implements IPlantable
{
    private String name = "diamondSeed";

    public DiamondSeedItem(String unlocalisedName)
    {
        super();
                             ...
                             float hitX, float hitY, float hitZ)
    {
        ...
        {
            world.setBlockState(pos.offset(EnumFacing.UP), CropBlocks.diamondCropBlock.getDefaultState());
