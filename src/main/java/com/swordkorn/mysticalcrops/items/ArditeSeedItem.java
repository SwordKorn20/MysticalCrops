 ...
 */
public class ArditeSeedItem extends Item implements IPlantable
{
    private String name = "arditeSeed";

    public ArditeSeedItem(String unlocalisedName)
    {
        super();
                             ...
                             float hitX, float hitY, float hitZ)
    {
        ...
        {
            world.setBlockState(pos.offset(EnumFacing.UP), CropBlocks.arditeCropBlock.getDefaultState());
    ...
    {
        return CropBlocks.arditeCropBlock.getDefaultState();
    }
}
