 ...
 */
public class CobaltSeedItem extends Item implements IPlantable
{
    private String name = "cobaltSeed";

    public CobaltSeedItem(String unlocalisedName)
    {
        super();
                             ...
                             float hitX, float hitY, float hitZ)
    {
        ...
        {
            world.setBlockState(pos.offset(EnumFacing.UP), CropBlocks.cobaltCropBlock.getDefaultState());
    ...
    {
        return CropBlocks.cobaltCropBlock.getDefaultState();
    }
}
