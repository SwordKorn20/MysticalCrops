 ...
 */
public class MysticalCropBlockGold extends BlockCrops implements IGrowable {

    public MysticalCropBlockGold(String unlocalisedName) {
    ...
    public java.util.List<ItemStack> getDrops(net.minecraft.world.IBlockAccess world, BlockPos pos, IBlockState state,
        ...
        for(int i = 0; i < 1 + fortune; i++) {
            ret.add(new ItemStack(CropItems.goldSeed, 1));
        }
        return ret;
    }
}
